...
- [Modern Web Podcast](https://twitter.com/moderndotweb)
    > A podcast that explores next generation frameworks, standards, and techniques.
...
- [The Undefined Podcast](https://twitter.com/theundefinedio?lang=en)
    > The only engineering podcast with a 2 drink minimum.
...
- [React Wednesdays](https://www.telerik.com/react-wednesdays)
    > React Wednesdays is a chat show with the best and brightest from the React world, hosted by Kathryn Grayson Nanz.
...
- [Adventures In Angular](https://twitter.com/angularpodcast)
    > The podcast about Angular and building awesome things on the internet. Join our weekly discussion about how to build top end Angular applications and become an Angular expert.
...
- [Back to Front Show](https://twitter.com/backtofrontshow)
    > The Kings of Silicon Gorge - superstar investors, entrepreneurs, independent creative thinkers, international jet set, web celebrities, & founders of nothing.
...
- [Boagworld](https://boagworld.com/)
    >  These bite-sized digital insights from UX designer and consultant Paul Boag will keep you up-to-date. Typically only a few minutes long they are ideal listening when on the move.
- [Changelog](https://twitter.com/changelog)
    > Conversations with the hackers, leaders, and innovators of the software world. Expect in-depth interviews with the best and brightest in software engineering, open source, and leadership.
- [Cloudcast](https://www.thecloudcast.net/)
    > The Cloudcast is the industry's leading, independent Cloud Computing podcast.
...
- [Into the Bytecode](https://share.transistor.fm/s/0f9aa81e)
    > Into the Bytecode is a podcast about the ideas shaping crypto. Sina Habibian previously worked on ecosystem development at the Ethereum Foundation.
